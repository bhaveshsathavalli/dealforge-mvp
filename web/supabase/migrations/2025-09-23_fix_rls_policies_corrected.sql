...
-- Handles cases where policies already exist
...
DROP POLICY IF EXISTS "Authenticated users can access compare runs" ON compare_runs;
...
DROP POLICY IF EXISTS "Authenticated users can access compare rows" ON compare_rows;
...
DROP POLICY IF EXISTS "Authenticated users can access battlecard bullets" ON battlecard_bullets;
...
DROP POLICY IF EXISTS "Authenticated users can access update events" ON update_events;
...
DROP POLICY IF EXISTS "Authenticated users can access personal saves" ON personal_saves;
...
DROP POLICY IF EXISTS "Authenticated users can access org snapshots" ON org_snapshots;
...
CREATE POLICY "facts_vendors_access" ON vendors
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_sources_access" ON sources
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_facts_access" ON facts
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_compare_runs_access" ON compare_runs
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_compare_rows_access" ON compare_rows
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_battlecard_bullets_access" ON battlecard_bullets
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_update_events_access" ON update_events
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_personal_saves_access" ON personal_saves
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "facts_org_snapshots_access" ON org_snapshots
  FOR ALL TO authenticated USING (true) WITH CHECK (true);
