-- Fix SQL conflicts by properly dropping existing policies and functions
-- This migration handles conflicts from previous attempts

-- Drop existing function if it exists (with different parameter names)
...
DROP POLICY IF EXISTS "Service role can access all compare_rows" ON compare_runs;
