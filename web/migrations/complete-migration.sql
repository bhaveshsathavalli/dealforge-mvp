-- Complete migration for org-scoped product and competitors
...
-- Step 4: Enable RLS on competitors table
ALTER TABLE competitors ENABLE ROW LEVEL SECURITY;

-- Step 5: Create RLS policies for competitors table
...
-- Step 6: Create function to generate slug from name
...
-- Step 8: Add unique constraint on org_id + slug combination
